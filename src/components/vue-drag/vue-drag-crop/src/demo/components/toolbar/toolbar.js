...
export default {
    ...
    setup(props, { emit }) {
        ...
        watch(showGrid, (val) =>
            emit('changeGrid', val, { gridX: gridX.value, gridY: gridY.value })
        );
        watch(gridX, (val) =>
            emit('changeGrid', showGrid.value, { gridX: val, gridY: gridY.value })
        );
        watch(gridY, (val) =>
            emit('changeGrid', showGrid.value, { gridX: gridX.value, gridY: val })
        );
