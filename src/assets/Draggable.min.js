    ...
    function (a, b, c) {
      var d,
        ...
        Z = function (a, b) {
          ...
          return Math.max(
            0,
            Y(a) ? Math.max(u[d], f[d]) - (window['inner' + c] || u[e] || f[e]) : a[d] - a[e]
          )
        },
        $ = function (a) {
          var b = Y(a),
        ...
        ga = function (a, b, c, d, e) {
          ...
          return (
            ...
            '%' === d && -1 !== b.indexOf('border')
              ...
              : ((i.cssText =
                  'border:0 solid red;position:' + ia(a, 'position', !0) + ';line-height:0;'),
                '%' !== d && h.appendChild
        ...
        ia = function (a, b, c) {
          ...
          return e || 0 === e
            ...
            : (a.style[b]
                ? (e = a.style[b])
                : (d = da(a))
                ? ((e = d.getPropertyValue(b.replace(/([A-Z])/g, '-$1').toLowerCase())),
                  (e = e || d.length ? e : d[b]))
          ...
          return (
            ...
            a.getBBox && ta(a)
              ...
              : (a.getBBox &&
                ...
                (c.x =
                  -1 !== g.indexOf('%') ? (a.offsetWidth * parseFloat(g)) / 100 : parseFloat(g)),
                (c.y =
                  -1 !== h.indexOf('%') ? (a.offsetHeight * parseFloat(h)) / 100 : parseFloat(h))),
            c
          )
        },
        za = function (a) {
        ...
        Aa = function (a, b, c, d) {
          ...
          return (
            ...
            b &&
              ...
              y && 'fixed' === ia(a, 'position', A) && ((e[4] += V()), (e[5] += U())),
              !y ||
                y === u ||
                B !== h.offsetParent ||
                z.isSVG ||
                ...
                j ||
                  ...
                  x.isSVG ||
                  x.isSVGRoot ||
                  ((e[4] -= parseInt(ia(z.offsetParent, 'borderLeftWidth'), 10) || 0),
                  (e[5] -= parseInt(ia(z.offsetParent, 'borderTopWidth'), 10) || 0)))),
            e
          )
        },
        Ba = function (a, b) {
          ...
          for (
            var c, d, e, f, g, h, i, j, k = ya(a, qa), l = ya(a.parentNode, ra), m = Aa(a, k, l);
          ...
          if (b)
            if (1 !== e && b instanceof Array) {
              ...
              'function' == typeof b
                ...
                : (j.end = b)
          return (
            (c || 0 === c) && (j.max = c), (d || 0 === d) && (j.min = d), f && (j.velocity = 0), j
          )
        },
        Pa = function (a) {
          var b
            ...
            (this.left = function (d, e) {
              ...
              return (f > 2 || -2 > f) && !e
                ...
                : ((d = -d),
                  ...
                  (o || g) &&
                    (h
                      ? this._suspendTransforms || (k[oa] = h + -o + 'px,' + -n + i)
                      : (k.left = -o + 'px'),
          ...
          var h,
                  ...
                  (c = Y(l.parentNode)),
                    ...
                    Fa &&
                      ...
                      0 > k
                        ...
                        : g > e.bottom - 40 && k
                        ? ((Wa = !0),
                          (j = Math.min(k, (m * (1 - Math.max(0, e.bottom - g) / 40)) | 0)))
                        : g < e.top + 40 &&
                          b.scrollTop &&
                          ((Wa = !0),
                          (j = -Math.min(
                    ...
                    Ea &&
                      ...
                      0 > k
                        ...
                        : f > e.right - 40 && k
                        ? ((Wa = !0),
                          (h = Math.min(k, (m * (1 - Math.max(0, e.right - f) / 40)) | 0)))
                        : f < e.left + 40 &&
                          b.scrollLeft &&
                          ((Wa = !0),
                          (h = -Math.min(
                ...
                p > n && n > -p && (n = 0),
                  ...
                  za
                    ...
                    ? (Fa && ((Ma.deltaY = o - qa.data.y), (qa.data.y = o)),
                      ...
                      qa.setRatio(1))
                    : (Fa &&
                        ((Ma.deltaY = o - parseFloat(d.style.top || 0)), (d.style.top = o + 'px')),
                      Ea &&
            ...
            ab = function (a, c) {
              ...
              d._gsTransform || (!ya && !za) || b.set(d, { x: '+=0', overwrite: !1 }),
                ...
                (ea || fa || ga) &&
                  ...
                  ea &&
                    ((e = ea(Ma.x)),
                    e !== Ma.x && ((Ma.x = e), za && (Ma.rotation = e), (ba = !0))),
                ...
                za
                  ...
                  : (ma &&
                    ...
                    (Ma.lockAxis || Ma.lockedAxis) &&
                      ...
                      h ||
                        ((Ma.lockedAxis = h =
                          Ea && Math.abs(c) > Math.abs(d) ? 'y' : Fa ? 'x' : null),
                        h &&
            ...
            pb = function (a) {
              if (a && Ma.isDragging && !i) {
                ...
                ;(c || e) &&
                  (ma
                    ? ((j -= c * ma[0] + e * ma[2]), (k -= e * ma[3] + c * ma[1]))
                    : ((j -= c), (k -= e)),
                  (b._gsScrollX += c),
                  (b._gsScrollY += e),
          ...
          ;(da = Ta.get(this.target)),
                ...
                if (
                  ...
                  for (
                    ...
                    (i = Y(f.parentNode)),
                      ...
                      (f = h)
                Ma.isThrowing &&
                  (e || Ma.endX > w || Ma.endX < y || Ma.endY > E || Ma.endY < H) &&
                  eb(g.throwProps, e)
              }
              return Ma
            }),
            ...
            (this.disable = function (a) {
              ...
              if ('soft' !== a) {
                ...
                Qa(Ra, !0),
                  la &&
                    (Ka(la, 'touchcancel', ob), Ka(la, 'touchend', ob), Ka(la, 'touchmove', mb)),
                  Ka(t, 'mouseup', ob),
                  Ka(t, 'mousemove', mb)
              }
              return (
